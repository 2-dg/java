...
public class RegGameController implements Initializable{
	...
	public void handleBtnRegist() {
		...
		try {
		gameVO = new GameVO(dpRGgamedate.getValue().toString(),
				...
				loseRate,Integer.parseInt(txtRGloseMoney.getText().trim()),
		...
		if(gameDAO != null) {
			...
			alert.showAndWait();
			ViewController.listOfGames.clear();
