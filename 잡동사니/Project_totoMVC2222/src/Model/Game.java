...
public class Game {
	...
	public Game(String date, String game, String league, String homeTeam, String awayTeam, double incomeRate,
	...
	public double getRewardWinMoney() {
		return winRate*winMoney;
	}
	public double getRewardDrawMoney() {
		return drawRate*drawMoney;
	}
	public double getRewardLoseMoney() {
		return loseRate*loseMoney;
	}
